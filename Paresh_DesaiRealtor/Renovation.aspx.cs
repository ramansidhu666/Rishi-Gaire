...
namespace Property
{
    public partial class Renovation : System.Web.UI.Page
    {
        #region Page Load
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            {
                cls_Property clsp = new cls_Property();
                //clsp.Insert_AddPowerOfSale(FirstName.Text, LastName.Text, txtEmail.Text, txtPhoneno.Text, search.Text, Remarks.Text);
        ...
        public void SendMailToAdmin(string UserEmailId)
        {
            ...
            mail.Subject = "Maninder Brara";
            string body = "";
            body = "<p>Person Name : " + FirstName.Text + " " + LastName.Text +"</p>";
            body = body + "<p>Email ID : " + UserEmailId + "</p>";
            body = body + "<p>Phone NO : " + txtPhoneno.Text + "</p>";
            body = body + "<p>Property Address : " + search.Text + "</p>";
            body = body + "<p>Remarks : " + Remarks.Text + "</p>";
            mail.Body = body;
