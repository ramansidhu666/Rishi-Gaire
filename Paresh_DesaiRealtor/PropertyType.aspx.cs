    ...
    public partial class PropertyType : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               // Session["PropertyType"] = Request.QueryString["PropertyType"];
                ...
                var Municipality = Request.QueryString["Municipality"].ToString();
                SearchResidentialProperties(Session["Municipality"].ToString());
        ...
        void SearchResidentialProperties(string ptype)
        {
            try
            {
                ...
                hlresi1.NavigateUrl = "../Search.aspx?Municipality=" + Session["Municipality"].ToString() + "&PropertyType=Residential";

                //string s1 = dt.Rows[1]["RemarksForClients"].ToString();

                imgresi2.ImageUrl =  "images/semi_detached.jpg";
                hlresi2.NavigateUrl = "../Search.aspx?Municipality=" + Session["Municipality"].ToString() + "&PropertyType=Commercial";
