 ...
 <script>
     ...
     $(document).ready(function () {
         $("#shareBtn").click(function () {
             ...
             var URL = 'http://www.timteams.com/PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <img src="../images/arshad.png" alt="" />
                        ...
                        <div class="roco_pro_info">
                            <h2>
                                <asp:Label ID="lblname" runat="server"></asp:Label>Krishna Timsina & Rishi Gaire</h2>
                            <p>Sales Representative</p>
                            <asp:Label CssClass="email_profile_r" ID="lblemail" runat="server"></asp:Label>
                            
                             <span class="email_profile_r">416-278-3979 , 647-296-8205</span>
                        </div>
                    </div>
