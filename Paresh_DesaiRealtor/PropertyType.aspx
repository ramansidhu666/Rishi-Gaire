                    ...
                    <div class="Residential_section_box"> 
                        <a href="" title="Toronto">
                            <asp:HyperLink ID="hlresi1" runat="server">
                              ...
                              <asp:Label ID="resicity1" runat="server">Residential Listings</asp:Label>
                        </a>
                    </div>
                </div> </div>
               <div class="col-md-4 col-sm-4"> <div class="Residential_section">
                    <div class="Residential_section_box">
                        ...
                        <asp:HyperLink ID="hlresi2" runat="server">
                         ...
                         <asp:Label ID="resicity2" runat="server">Commercial Listings</asp:Label>
                               </a>
                    </div>
                </div> </div>
               <div class="col-md-4 col-sm-4"> <div class="Residential_section">
                    <div class="Residential_section_box">
                        ...
                        <asp:HyperLink ID="hlresi3" runat="server">
                         ...
                         <asp:Label ID="resicity3" runat="server">Condo Listings</asp:Label>
                              </a>
                    </div>
                </div> </div>
